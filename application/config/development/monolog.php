 ...
 * Filename will be encoded to current system date, ie. YYYY-MM-DD-codeigniter.log
 */
 ...
 * Log to default CI log directory (must be writable ie. chmod 757).
 * Filename will be encoded to current system date, ie. YYYY-MM-DD-monolog.log
*/
